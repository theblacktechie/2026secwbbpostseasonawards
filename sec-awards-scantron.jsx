...
function FlipCard({ award, onClose }) {
  ...
  return (
    <div style={{ padding: "10px 16px 14px", background: "rgba(0,48,135,0.05)", borderTop: "2px solid #003087" }}>
      ...
      {/* 3-D scene — no fixed height, content drives size */}
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ padding: "12px 16px 0" }}>
              ...
              {/* Highlight — directly under position, tight gap */}
            ...
            {/* Flip hint — immediately follows content */}
          ...
          {/* ── BACK ── absolute, matches front height automatically ── */}
          <div style={{
